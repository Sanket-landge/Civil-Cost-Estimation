...
public class RccSlabScreen extends JFrame implements ActionListener
    {
        JLabel l1,l2,l3,l4,l5,l6,l7,l8,ll,lb;
        JLabel l9,l10,l11,l12,l13,l14,l15,l16;
	...
	Dimension screen 	= 	Toolkit.getDefaultToolkit().getScreenSize();
		...
		setLocation((screen.width - 620)/2,((screen.height-638)/2)-17);	
                ...
                l13 = new JLabel("Total Thicknessn m) :-");
...
try
{
rs=stm.executeQuery("select * from Rccslab where Custno=(select max(Custno) from Rccslab)");
...
{}
		...
		tno.setEnabled(true);
			...
			if(i==1)
			{
                        try
                            {
                                stm = cn.createStatement();
					 //sql = "insert into Rccslab values("+tcno.getText()+ ",'" +tname.getText()+"'," +ttno.getText()+"," +ttlen.getText()+"," +ttbred.getText()+"," +ttrate.getText()+"," +ttquan.getText()+","+ttamt.getText()+")";
                               stm.executeUpdate ("update Rccslab set Custname='" +tname.getText()+ "',No=" +ttno.getText()+" ,Lenght=" +ttlen.getText()+" ,Breadth=" +ttbred.getText()+" ,Rate=" +ttrate.getText()+",Quantity=" +ttquan.getText()+",Totamount="+ttamt.getText()+ " where Custno="+tcno.getText());//where Custno='"+tcno.getText()+"'");
                               stm.close();
		...
		if(e.getSource()==bcal)
			...
			if(i==1)
			{
				...
				String	sql1 = "Update final set SAmt="+ttamt.getText()+" where Name='"+tname.getText()+"'";
